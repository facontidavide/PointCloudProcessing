...
class Value
{
  public:
    ...
    virtual vcg::Matrix44f getMatrix44f() const
    {
        assert(0);
        return vcg::Matrix44f();
    }
    virtual vcg::Point3f getPoint3f() const
    {
        assert(0);
        return vcg::Point3f();
    }
    ...
    virtual double getAbsPerc() const
    {
        assert(0);
        return double();
    }
    ...
    virtual QList<double> getDoubleList() const
    {
        assert(0);
        return QList<double>();
    }
    virtual double getDynamicDouble() const
    {
        assert(0);
        return double();
    }
    ...
    virtual bool isMatrix44f() const
    {
        return false;
    }
    virtual bool isPoint3f() const
    {
        return false;
    }
    ...
    virtual bool isDoubleList() const
    {
        return false;
    }
    virtual bool isDynamicDouble() const
    {
        return false;
    }
...
class Matrix44fValue : public Value
{
  public:
    ...
    inline vcg::Matrix44f getMatrix44f() const
    {
        return pval;
    }
    inline bool isMatrix44f() const
    {
        return true;
    }
    inline void set(const Value& p)
...
class Point3fValue : public Value
{
  public:
    ...
    inline vcg::Point3f getPoint3f() const
    {
        return pval;
    }
    inline bool isPoint3f() const
    {
        return true;
    }
    inline void set(const Value& p)
...
class AbsPercValue : public DoubleValue
{
  public:
    ...
    inline double getAbsPerc() const
    {
        return getDouble();
    }
    inline bool isAbsPerc() const
    {
        return true;
    }
    ~AbsPercValue()
...
class DoubleListValue : public Value
{
  public:
    ...
    inline QList<double> getDoubleList() const
    {
        return pval;
    }
    inline void set(const Value& p)
    {
        pval = p.getDoubleList();
    }
    inline bool isDoubleList() const
    {
        return true;
    }
    ~DoubleListValue()
...
class DynamicDoubleValue : public DoubleValue
{
  public:
    ...
    inline double getDynamicDouble() const
    {
        return getDouble();
    }
    inline bool isDynamicDouble() const
    {
        return true;
    }
    ~DynamicDoubleValue()
...
{
  public:
    AbsPercDecoration(AbsPercValue* defvalue, const double minVal, const double maxVal, const QString desc = QString(),
...
{
  public:
    EnumDecoration(EnumValue* defvalue, QStringList values, const QString desc = QString(),
                   const QString tltip = QString());
...
{
  public:
    DynamicDoubleDecoration(DynamicDoubleValue* defvalue, const double minVal, const double maxVal,
...
{
  public:
    SaveFileDecoration(FileValue* defvalue, const QString extension, const QString desc = QString(),
                       const QString tltip = QString());
    ~SaveFileDecoration()
    {
    }
...
{
  public:
    OpenFileDecoration(FileValue* directorydefvalue, const QStringList extensions, const QString desc = QString(),
                       const QString tltip = QString());
    ~OpenFileDecoration()
    {
    }
...
class RichInt : public RichParameter
{
  public:
    ...
    RichInt(const QString nm, const int val, const int defval, const QString desc = QString(),
            const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichInt();
...
class RichDouble : public RichParameter
{
  public:
    ...
    RichDouble(const QString nm, const double val, const double defval, const QString desc = QString(),
               const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichDouble();
...
{
  public:
    RichMatrix44f(const QString nm, const vcg::Matrix44f& defval, const QString desc = QString(),
                  const QString tltip = QString());
    RichMatrix44f(const QString nm, const vcg::Matrix44f& val, const vcg::Matrix44f& defval,
                  const QString desc = QString(), const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichMatrix44f();
...
{
  public:
    RichPoint3f(const QString nm, const vcg::Point3f defval, const QString desc = QString(),
                const QString tltip = QString());
    RichPoint3f(const QString nm, const vcg::Point3f val, const vcg::Point3f defval, const QString desc = QString(),
                const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichPoint3f();
...
{
  public:
    RichAbsPerc(const QString nm, const double defval, const double minval, const double maxval,
                const QString desc = QString(), const QString tltip = QString());
    RichAbsPerc(const QString nm, const double val, const double defval, const double minval, const double maxval,
                const QString desc = QString(), const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichAbsPerc();
...
{
  public:
    RichEnum(const QString nm, const int defval, const QStringList values, const QString desc = QString(),
             const QString tltip = QString());
    RichEnum(const QString nm, const int val, const int defval, const QStringList values,
             const QString desc = QString(), const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichEnum();
...
{
  public:
    RichDynamicDouble(const QString nm, const double defval, const double minval, const double maxval,
                      const QString desc = QString(), const QString tltip = QString());
    RichDynamicDouble(const QString nm, const double val, const double defval, const double minval, const double maxval,
                      const QString desc = QString(), const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichDynamicDouble();
...
{
  public:
    RichOpenFile(const QString nm, const QString directorydefval, const QStringList exts,
                 const QString desc = QString(), const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichOpenFile();
...
{
  public:
    RichSaveFile(const QString nm, const QString filedefval, const QString ext, const QString desc = QString(),
                 const QString tltip = QString());
    void accept(Visitor& v);
    bool operator==(const RichParameter& rb);
    ~RichSaveFile();
...
// 	void fillRichParameterAttribute(const QString& type,const QString& name,const QString& val,const QString& desc,const
// QString& tooltip);
// };
