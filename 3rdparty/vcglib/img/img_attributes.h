...
class ImgAttributes
{
  ...
  public:
    ...
    template <typename OtherScalarType>
    void getReferenceWhite(OtherScalarType &ret_reference_white_x, OtherScalarType &ret_reference_white_y,
                           OtherScalarType &ret_reference_white_z) const
    {
        STATIC_FLOAT_OR_DOUBLE_TYPECHECK(OtherScalarType);
    ...
    void setReferenceWhite(ScalarType arg_reference_white_x, ScalarType arg_reference_white_y,
    ...
    {
        return (_range_min == arg_range_min) && (_range_max == arg_range_max);
    }

    bool hasReferenceWhite(ScalarType arg_reference_white_x, ScalarType arg_reference_white_y,
                           ScalarType arg_reference_white_z) const
    {
        return (_reference_white_x == arg_reference_white_x) && (_reference_white_y == arg_reference_white_y) &&
               (_reference_white_z == arg_reference_white_z);
    }
    ...
    {
        return (_range_min == attributes._range_min) && (_range_max == attributes._range_max);
    }
    ...
    {
        return hasColorspace(attributes) && hasGamma(attributes) && hasRange(attributes) &&
