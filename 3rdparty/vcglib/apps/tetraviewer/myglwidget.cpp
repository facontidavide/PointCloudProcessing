...
void MyGLWidget::DrawTetraMesh()
{
    switch (modality)
    {
        case 0:
            ...
            break;
        case 1:
            WT->Draw<vcg::GLW::DMWire, vcg::GLW::NMFlat, vcg::GLW::CMNone>();
            break;
        case 2:
            WT->Draw<vcg::GLW::DMHidden, vcg::GLW::NMFlat, vcg::GLW::CMNone>();
            break;
        case 3:
            WT->Draw<vcg::GLW::DMFlat, vcg::GLW::NMFlat, vcg::GLW::CMNone>();
            break;
        case 4:
            WT->Draw<vcg::GLW::DMFlatWire, vcg::GLW::NMFlat, vcg::GLW::CMNone>();
            break;
        case 5:
            WT->Draw<vcg::GLW::DMFlat, vcg::GLW::NMSmooth, vcg::GLW::CMNone>();
            break;
        case 6:
            WT->Draw<vcg::GLW::DMSmallTetra, vcg::GLW::NMFlat, vcg::GLW::CMNone>();
            break;
    }
}
...
void MyGLWidget::mouseMoveEvent(QMouseEvent *e)
{
    ...
    else if ((mouse_modality == MMNavigateSection) && (e->state() & Qt::LeftButton))
    {
        LoadMatrix();
