...
class MyVertex
  : public Vertex<MyUsedTypes, vertex::VFAdj, vertex::Coord3f, vertex::Normal3f, vertex::Mark, vertex::BitFlags>
{
  public:
...
class MyEdge : public Edge<MyUsedTypes, edge::VertexRef>
{
  public:
    inline MyEdge(){};
    inline MyEdge(MyVertex *v0, MyVertex *v1)
    {
        V(0) = v0;
        V(1) = v1;
    };
...
int main(int argc, char **argv)
{
    ...
    if (TargetError < numeric_limits<float>::max())
