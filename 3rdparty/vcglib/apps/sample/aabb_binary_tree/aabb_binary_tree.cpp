...
struct MyUsedTypes : public vcg::UsedTypes<vcg::Use<AVertex>::AsVertexType, vcg::Use<AFace>::AsFaceType>
{
};
...
static void TestKClosest(void)
{
    ...
    vcg::EmptyClass a;
    unsigned int rk =
      gIndex.GetKClosest(getPtDist, a, k, queryPoint, maxDist, closestObjects, closestDistances, closestPoints);
