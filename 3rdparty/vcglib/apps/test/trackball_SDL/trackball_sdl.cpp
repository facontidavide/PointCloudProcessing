...
void SetTrackball(int mode)
{
    ...
    switch (mode)
    {
        case 1:
            ...
            track.modes[vcg::Trackball::WHEEL] = track.modes[vcg::Trackball::BUTTON_LEFT] = track.idle_and_keys_mode =
              &navigatorMode;
        ...
        default:
            ...
            track.modes[vcg::Trackball::WHEEL] = track.modes[vcg::Trackball::BUTTON_LEFT | vcg::Trackball::KEY_SHIFT] =
              &scaleMode;
            track.modes[vcg::Trackball::BUTTON_LEFT | vcg::Trackball::KEY_ALT] = &zMode;
            track.modes[vcg::Trackball::BUTTON_MIDDLE | vcg::Trackball::KEY_ALT] = track.idle_and_keys_mode =
              &sphereMode;
...
vcg::Trackball::Button SDL2VCG(int code)
{
    switch (code)
    {
        case SDL_BUTTON_LEFT:
            return vcg::Trackball::BUTTON_LEFT;
        case SDL_BUTTON_MIDDLE:
            return vcg::Trackball::BUTTON_MIDDLE;
        case SDL_BUTTON_RIGHT:
            return vcg::Trackball::BUTTON_RIGHT;
        case SDLK_RCTRL:
        case SDLK_LCTRL:
            return vcg::Trackball::KEY_CTRL;
        case SDLK_RALT:
        case SDLK_LALT:
            return vcg::Trackball::KEY_ALT;
        case SDLK_LSHIFT:
        case SDLK_RSHIFT:
            return vcg::Trackball::KEY_SHIFT;
        case SDLK_LEFT:
        case SDLK_a:
            return vcg::Trackball::KEY_LEFT;
        case SDLK_RIGHT:
        case SDLK_d:
            return vcg::Trackball::KEY_RIGHT;
        case SDLK_UP:
        case SDLK_w:
            return vcg::Trackball::KEY_UP;
        case SDLK_DOWN:
        case SDLK_s:
            return vcg::Trackball::KEY_DOWN;
        case SDLK_PAGEUP:
        case SDLK_r:
            return vcg::Trackball::KEY_PGUP;
        case SDLK_PAGEDOWN:
        case SDLK_f:
            return vcg::Trackball::KEY_PGDOWN;
        ...
        switch (event.type)
        {
            ...
            case SDL_KEYDOWN:
                switch (event.key.keysym.sym)
                {
                    ...
                    case SDLK_HOME:
                        ...
                        break;
                    case SDLK_SPACE:
                        trackballMode = (trackballMode + 1) % 2;
                        printf("Trackball Mode %i\n", drawMode);
                        SetTrackball(trackballMode);
                        break;
                    default:
                        track.ButtonDown(SDL2VCG(event.key.keysym.sym));
                }
                redraw_needed = true;
                break;
            case SDL_KEYUP:
                track.ButtonUp(SDL2VCG(event.key.keysym.sym));
                break;
            case SDL_MOUSEBUTTONDOWN:
                switch (event.button.button)
                {
                    ...
                    case SDL_BUTTON_WHEELDOWN:
                        ...
                        break;
                    default:
                        track.MouseDown(event.button.x, (height - event.button.y), SDL2VCG(event.button.button));
                        break;
                }
                break;
            case SDL_MOUSEBUTTONUP:
                track.MouseUp(event.button.x, (height - event.button.y), SDL2VCG(event.button.button));
                break;
                break;
            ...
            case SDL_TIMER:
                if (onTimer())
                    redraw_needed = true;
                if (redraw_needed)
                    sendRedraw();  // justs sends a redraw event!
                redraw_needed = false;
                break;
