  ...
  public:
    ...
    **/
    ...
    inline Point4 VectProd(const Point4 &x, const Point4 &z) const
    {
        ...
        res[0] = y[1] * x[2] * z[3] - y[1] * x[3] * z[2] - x[1] * y[2] * z[3] + x[1] * y[3] * z[2] +
                 z[1] * y[2] * x[3] - z[1] * y[3] * x[2];
        res[1] = y[0] * x[3] * z[2] - z[0] * y[2] * x[3] - y[0] * x[2] * z[3] + z[0] * y[3] * x[2] +
                 x[0] * y[2] * z[3] - x[0] * y[3] * z[2];
        res[2] = -y[0] * z[1] * x[3] + x[0] * z[1] * y[3] + y[0] * x[1] * z[3] - x[0] * y[1] * z[3] -
                 z[0] * x[1] * y[3] + z[0] * y[1] * x[3];
        res[3] = -z[0] * y[1] * x[2] - y[0] * x[1] * z[2] + x[0] * y[1] * z[2] + y[0] * z[1] * x[2] -
                 x[0] * z[1] * y[2] + z[0] * x[1] * y[2];
        return res;
    }
    //@}
    ...
    **/
    ...
    inline T dot(const Point4 &p) const
    {
        return (*this) * p;
    }
    inline Point4 operator^(const Point4 &p) const
