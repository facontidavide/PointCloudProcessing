...
template <class T>
void Sphere3<T>::Add(const Sphere3<T> &sphere)
{
    if (IsEmpty())
    {
        *this = sphere;
...
template <class T>
void Sphere3<T>::Add(const Point3<T> &p)
{
    if (IsEmpty())
    {
        _center = p;
...
template <class T>
bool Sphere3<T>::IsIn(const Point3<T> &p) const
{
    if (IsEmpty())
        return false;
    Point3<T> dist = p - _center;
...
template <class T>
bool Sphere3<T>::IsIn(const Sphere3<T> &p) const
{
    if (IsEmpty())
        return false;
...
template <class T>
void Sphere3<T>::Intersect(const Sphere3<T> &s)
{
...
template <class T>
int Sphere3<T>::CreateFromBox(int n, const Point3<T> *points)
{
...
template <class T>
int Sphere3<T>::CreateTight(int n, const Point3<T> *points, T threshold, T speed)
{
...
template <class T>
int Sphere3<T>::CreateTight(const std::vector<Point3<T> > &points, T threshold, T speed)
{
