...
class Point
{
  ...
  public:
    ...
    inline const S &X() const
    {
        return _v[0];
    }
    inline const S &Y() const
    {
        return _v[1];
    }
    inline const S &Z() const
    {
        static_assert(N > 2);
        return _v[2];
    }
...
class Point3 : public Point<3, S>
{
  public:
    ...
    inline PointType operator^(PointType const &p) const
    {
        return Point3(_v[1] * p._v[2] - _v[2] * p._v[1], _v[2] * p._v[0] - _v[0] * p._v[2],
    ...
    inline S NormInfinity() const
    {
        return math::Max(math::Max(math::Abs(_v[0]), math::Abs(_v[1])), math::Abs(_v[3]));
    }
...
class Point4 : public Point<4, S>
{
  public:
    ...
    inline bool operator<(PointType const &p) const
    {
        return (_v[3] != p._v[3]) ? (_v[3] < p._v[3]) : (_v[2] != p._v[2]) ? (_v[2] < p._v[2]) : (_v[1] != p._v[1]) ?
                                                                             (_v[1] < p._v[1]) :
                                                                             (_v[0] < p._v[0]);
    }
    ...
    inline S NormInfinity() const
    {
        return math::Max(math::Max(math::Abs(_v[0]), math::Abs(_v[1])), math::Max(math::Abs(_v[2]), math::Abs(_v[3])));
    }
