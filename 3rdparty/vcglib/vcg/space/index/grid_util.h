...
Removed BestDim function from the grid_static_ptr class and moved to a indipendent file (grid_util.h) for sake of
generality.
...
class BasicGrid  //:public SpatialIndex<SCALARTYPE>
{
  public:
    ...
    */
	 ...
	 * @param integer coordinates pi of the cell
	 * @return b is the corresponding box in <ScalarType> coordinates
	 */ inline void IPiToBoxCenter(const Point3i &pi,
                                                                                          CoordType &c) const
    {
        CoordType p;
        IPiToPf(pi, p);
...
void BestDim(const Box3<scalar_type> box, const scalar_type voxel_size, Point3i &dim)
{
    ...
    __int64 elem_num = (__int64)(box_size[0] / voxel_size + 0.5) * (__int64)(box_size[1] / voxel_size + 0.5) *
                       (__int64)(box_size[2] / voxel_size + 0.5);
