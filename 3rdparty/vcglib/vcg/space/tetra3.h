...
class Tetra
{
  public:
    ...
    static int VofE(const int &indexE, const int &indexV)
    {
        ...
        static int edgevert[6][2] = { { 0, 1 }, { 0, 2 }, { 0, 3 }, { 1, 2 }, { 1, 3 }, { 2, 3 } };
    ...
    static int VofF(const int &indexF, const int &indexV)
    {
        ...
        static int facevert[4][3] = { { 0, 1, 2 }, { 0, 3, 1 }, { 0, 2, 3 }, { 1, 3, 2 } };
    ...
    static int EofV(const int &indexV, const int &indexE)
    {
        ...
        static int vertedge[4][3] = { { 0, 1, 2 }, { 0, 3, 4 }, { 5, 1, 3 }, { 4, 5, 2 } };
    ...
    static int EofF(const int &indexF, const int &indexE)
    {
        ...
        static int faceedge[4][3] = { { 0, 3, 1 }, { 2, 4, 0 }, { 1, 5, 2 }, { 4, 5, 3 } };
    ...
    static int FofV(const int &indexV, const int &indexF)
    {
        ...
        static int vertface[4][3] = { { 0, 1, 2 }, { 0, 3, 1 }, { 0, 2, 3 }, { 1, 3, 2 } };
    ...
    static int FofE(const int &indexE, const int &indexSide)
    {
        ...
        static int edgeface[6][2] = { { 0, 1 }, { 0, 2 }, { 1, 2 }, { 0, 3 }, { 1, 3 }, { 2, 3 } };
    ...
    static int VofEE(const int &indexE0, const int &indexE1)
    {
        ...
        static int edgesvert[6][6] = { { -1, 0, 0, 1, 1, -1 }, { 0, -1, 0, 2, -1, 2 }, { 0, 0, -1, -1, 3, 3 },
    ...
    static int EofFF(const int &indexF0, const int &indexF1)
    {
        assert((indexF0 < 4) && (indexF0 >= 0));
        assert((indexF1 < 4) && (indexF1 >= 0));
        static int facesedge[4][4] = { { -1, 0, 1, 3 }, { 0, -1, 2, 4 }, { 1, 2, -1, 5 }, { 3, 4, 5, -1 } };
    ...
    static int EofVV(const int &indexV0, const int &indexV1)
    {
        ...
        static int verticesedge[4][4] = { { -1, 0, 1, 2 }, { 0, -1, 3, 4 }, { 1, 3, -1, 5 }, { 2, 4, 5, -1 } };
    ...
    static int FofVVV(const int &indexV0, const int &indexV1, const int &indexV2)
    {
        ...
        static int verticesface[4][4][4] = { { // 0
                                               { -1, -1, -1, -1 },
                                               { -1, -1, 0, 1 },
                                               { -1, 0, -1, 2 },
                                               { -1, 1, 2, -1 } },
    ...
    static int FofEE(const int &indexE0, const int &indexE1)
    {
        assert((indexE0 < 6) && (indexE0 >= 0));
        assert((indexE1 < 6) && (indexE1 >= 0));
        static int edgesface[6][6] = { { -1, 0, 1, 0, 1, -1 }, { 0, -1, 2, 0, -1, 2 }, { 1, 2, -1, -1, 1, 2 },
                                       { 0, 0, -1, -1, 3, 3 }, { 1, -1, 1, 3, -1, 3 }, { -1, 2, 2, 3, 3, -1 } };
...
/**
    ...
    Note the relation with the Face class of TetraMesh complex, both classes provide the P(i) access functions to their
...
class Tetra3 : public Tetra
{
  ...
  public:
    ...
    inline CoordType const &cP(const int j) const
    {
        return _v[j];
    }
    ...
    inline CoordType &P3(const int j)
    {
        return _v[(j + 3) % 4];
    }
    ...
    inline const CoordType &P3(const int j) const
    {
        return _v[(j + 3) % 4];
    }
    ...
    inline const CoordType &cP3(const int j) const
    {
        return _v[(j + 3) % 4];
    }
...
{
    return (((t.cP(Tetra::VofF(face, 1)) - t.cP(Tetra::VofF(face, 0))) ^
             (t.cP(Tetra::VofF(face, 2)) - t.cP(Tetra::VofF(face, 0))))
              .Normalize());
}
/*@}*/
}  // end namespace
