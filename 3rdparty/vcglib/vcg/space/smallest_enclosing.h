...
draft version. For the triangle is not tehe smallest enclosing sphere and for the set of spheres works only for two
spheres
...
template <class TriangleType>
Sphere3<typename TriangleType::ScalarType> SmallestEnclosing::SphereOfTriangle(const TriangleType& t)
{
    return Sphere3<typename TriangleType::ScalarType>(t.Barycenter(), (t.Barycenter() - t.cP(0)).Norm());
}

template <class TetraType>
Sphere3<typename TetraType::ScalarType> SmallestEnclosing::SphereOfTetra(const TetraType& t)
{
    return Sphere3<typename TetraType::ScalarType>(t.Barycenter(), (t.Barycenter() - t.cP(0)).Norm());
}

template <class SphereType>
SphereType SmallestEnclosing::SphereOfSpheres(const SphereType& s0, const SphereType& s1)
{
...
typename SphereContType::value_type SmallestEnclosing::SphereOfSpheres(const SphereContType& spheres)
{
