...
class SparseMatrixBase
{
  public:
    ...
    enum
    {
        ...
        MaxSizeAtCompileTime = (ei_size_at_compile_time<MaxRowsAtCompileTime, MaxColsAtCompileTime>::ret),
    ...
    inline void assignGeneric(const OtherDerived& other)
    {
        ...
        ei_assert(
          (((ei_traits<Derived>::SupportedAccessPatterns & OuterRandomAccessPattern) == OuterRandomAccessPattern) ||
    ...
    //     template<typename Lhs,typename Rhs>
    //     Derived& operator+=(const Flagged<Product<Lhs,Rhs,CacheFriendlyProduct>, 0, EvalBeforeNestingBit |
    ...
    template <typename OtherDerived>
    friend const typename SparseProductReturnType<OtherDerived, Derived>::Type
    ...
    //     static const CwiseNullaryOp<CustomNullaryOp, Derived> NullaryExpr(int rows, int cols, const CustomNullaryOp&
    //     func);
    //     template<typename CustomNullaryOp>
