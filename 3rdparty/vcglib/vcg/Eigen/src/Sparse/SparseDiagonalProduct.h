...
class SparseDiagonalProduct : public SparseMatrixBase<SparseDiagonalProduct<LhsNested, RhsNested> >,
                              ei_no_assignment_operator
{
    ...
    enum
    {
        LhsMode = (_LhsNested::Flags & Diagonal) == Diagonal ? SDP_IsDiagonal : (_LhsNested::Flags & RowMajorBit) ?
                                                               SDP_IsSparseRowMajor :
                                                               SDP_IsSparseColMajor,
        RhsMode = (_RhsNested::Flags & Diagonal) == Diagonal ? SDP_IsDiagonal : (_RhsNested::Flags & RowMajorBit) ?
                                                               SDP_IsSparseRowMajor :
                                                               SDP_IsSparseColMajor
    };
  ...
  public:
    ...
    typedef ei_sparse_diagonal_product_inner_iterator_selector<_LhsNested, _RhsNested, SparseDiagonalProduct, LhsMode,
                                                               RhsMode>
      InnerIterator;

    template <typename Lhs, typename Rhs>
    EIGEN_STRONG_INLINE SparseDiagonalProduct(const Lhs& lhs, const Rhs& rhs) : m_lhs(lhs), m_rhs(rhs)
    {
...
class ei_sparse_diagonal_product_inner_iterator_selector<Lhs, Rhs, SparseDiagonalProductType, SDP_IsDiagonal,
                                                         SDP_IsSparseRowMajor>
  : public SparseCwiseUnaryOp<ei_scalar_multiple_op<typename Lhs::Scalar>, Rhs>::InnerIterator
{
  ...
  public:
    inline ei_sparse_diagonal_product_inner_iterator_selector(const SparseDiagonalProductType& expr, int outer)
...
class ei_sparse_diagonal_product_inner_iterator_selector<Lhs, Rhs, SparseDiagonalProductType, SDP_IsDiagonal,
                                                         SDP_IsSparseColMajor>
  : public SparseCwiseBinaryOp<ei_scalar_product_op<typename Lhs::Scalar>, SparseInnerVectorSet<Rhs, 1>,
                               typename Lhs::_CoeffsVectorType>::InnerIterator
{
    typedef typename SparseCwiseBinaryOp<ei_scalar_product_op<typename Lhs::Scalar>, SparseInnerVectorSet<Rhs, 1>,
...
template <typename Lhs, typename Rhs, typename SparseDiagonalProductType>
class ei_sparse_diagonal_product_inner_iterator_selector<Lhs, Rhs, SparseDiagonalProductType, SDP_IsSparseColMajor,
                                                         SDP_IsDiagonal>
...
template <typename Lhs, typename Rhs, typename SparseDiagonalProductType>
class ei_sparse_diagonal_product_inner_iterator_selector<Lhs, Rhs, SparseDiagonalProductType, SDP_IsSparseRowMajor,
                                                         SDP_IsDiagonal>
  : public SparseCwiseBinaryOp<ei_scalar_product_op<typename Rhs::Scalar>, SparseInnerVectorSet<Lhs, 1>,
                               NestByValue<Transpose<typename Rhs::_CoeffsVectorType> > >::InnerIterator
{
    typedef typename SparseCwiseBinaryOp<ei_scalar_product_op<typename Rhs::Scalar>, SparseInnerVectorSet<Lhs, 1>,
