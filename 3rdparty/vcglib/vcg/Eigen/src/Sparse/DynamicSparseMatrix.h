...
template <typename _Scalar, int _Flags>
class DynamicSparseMatrix : public SparseMatrixBase<DynamicSparseMatrix<_Scalar, _Flags> >
{
  public:
  ...
  public:
    ...
    inline DynamicSparseMatrix(int rows, int cols) : m_innerSize(0)
    {
        resize(rows, cols);
    }

    template <typename OtherDerived>
    inline DynamicSparseMatrix(const SparseMatrixBase<OtherDerived>& other) : m_innerSize(0)
    {
        *this = other.derived();
    }
...
class DynamicSparseMatrix<Scalar, _Flags>::InnerIterator : public SparseVector<Scalar, _Flags>::InnerIterator
{
  ...
  public:
    InnerIterator(const DynamicSparseMatrix& mat, int outer) : Base(mat.m_data[outer]), m_outer(outer)
    {
    }
