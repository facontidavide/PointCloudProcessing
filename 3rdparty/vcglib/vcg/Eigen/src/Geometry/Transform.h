...
template <typename Other, int Dim, int HDim, int OtherRows = Other::RowsAtCompileTime,
...
{
    EIGEN_STATIC_ASSERT(Dim == 2, YOU_MADE_A_PROGRAMMING_MISTAKE)
    return QMatrix(other.coeffRef(0, 0), other.coeffRef(1, 0), other.coeffRef(0, 1), other.coeffRef(1, 1),
...
template <typename Scalar, int Dim>
template <typename OtherDerived>
Transform<Scalar, Dim>& Transform<Scalar, Dim>::pretranslate(const MatrixBase<OtherDerived>& other)
{
    EIGEN_STATIC_ASSERT_VECTOR_SPECIFIC_SIZE(OtherDerived, int(Dim))
    translation() += other;
    return *this;
...
/** \nonstableyet
  ...
  */
template <typename Scalar, int Dim>
inline const typename Transform<Scalar, Dim>::MatrixType Transform<Scalar, Dim>::inverse(TransformTraits traits) const
{
...
struct ei_transform_product_impl<Other, Dim, HDim, Dim, 1>
{
    ...
    typedef const CwiseUnaryOp<
      ...
      NestByValue<CwiseBinaryOp<ei_scalar_sum_op<Scalar>,
