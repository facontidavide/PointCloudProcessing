...
class ParametrizedLine
{
  public:
    ...
    /** Initializes a parametrized line of direction \a direction and origin \a origin.
      ...
      */
    ParametrizedLine(const VectorType& origin, const VectorType& direction) : m_origin(origin), m_direction(direction)
    {
    }
    ...
    inline
      typename ei_cast_return_type<ParametrizedLine, ParametrizedLine<NewScalarType, AmbientDimAtCompileTime> >::type
      cast() const
    {
...
{
    return -(hyperplane.offset() + origin().dot(hyperplane.normal())) / (direction().dot(hyperplane.normal()));
}
