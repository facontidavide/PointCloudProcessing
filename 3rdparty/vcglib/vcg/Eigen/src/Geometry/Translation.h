...
inline
  typename Translation<Scalar, Dim>::TransformType Translation<Scalar, Dim>::operator*(const ScalingType& other) const
{
    TransformType res;
    res.matrix().setZero();
...
template <typename Scalar, int Dim>
inline typename Translation<Scalar, Dim>::TransformType Translation<Scalar, Dim>::
...
template <typename Scalar, int Dim>
inline
  typename Translation<Scalar, Dim>::TransformType Translation<Scalar, Dim>::operator*(const TransformType& t) const
{
    TransformType res = t;
