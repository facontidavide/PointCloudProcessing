...
class Hyperplane
{
  public:
    ...
    /** Applies the transformation \a t to \c *this and returns a reference to \c *this.
      ...
      */
    inline Hyperplane& transform(const Transform<Scalar, AmbientDimAtCompileTime>& t, TransformTraits traits = Affine)
    {
    ...
    inline typename ei_cast_return_type<Hyperplane, Hyperplane<NewScalarType, AmbientDimAtCompileTime> >::type
    cast() const
    {
        return
          typename ei_cast_return_type<Hyperplane, Hyperplane<NewScalarType, AmbientDimAtCompileTime> >::type(*this);
    }
