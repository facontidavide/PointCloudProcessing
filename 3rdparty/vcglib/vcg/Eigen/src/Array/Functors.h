...
struct ei_functor_traits<std::unary_negate<T> >
{
    enum
    {
        Cost = 1 + ei_functor_traits<T>::Cost,
        PacketAccess = false
    };
};
...
struct ei_functor_traits<std::unary_compose<T0, T1> >
{
    enum
    {
        Cost = ei_functor_traits<T0>::Cost + ei_functor_traits<T1>::Cost,
        PacketAccess = false
    };
};
...
struct ei_functor_traits<std::binary_compose<T0, T1, T2> >
{
    enum
    {
        Cost = ei_functor_traits<T0>::Cost + ei_functor_traits<T1>::Cost + ei_functor_traits<T2>::Cost,
        PacketAccess = false
    };
};
