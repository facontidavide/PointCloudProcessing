               ...
               public MatrixBase<Select<ConditionMatrixType, ThenMatrixType, ElseMatrixType> >
{
  public:
    ...
    Select(const ConditionMatrixType& conditionMatrix, const ThenMatrixType& thenMatrix,
...
MatrixBase<Derived>::select(const MatrixBase<ThenDerived>& thenMatrix, const MatrixBase<ElseDerived>& elseMatrix) const
{
...
MatrixBase<Derived>::select(const MatrixBase<ThenDerived>& thenMatrix, typename ThenDerived::Scalar elseScalar) const
{
...
MatrixBase<Derived>::select(typename ElseDerived::Scalar thenScalar, const MatrixBase<ElseDerived>& elseMatrix) const
{
