...
struct ei_result_of<Func(ArgType0, ArgType1)>
{
    ...
    static ei_has_std_result_type testFunctor(T const *, typename T::result_type const * = 0);
    template <typename T>
    static ei_has_tr1_result testFunctor(T const *,
...
template <typename T, typename U>
struct ei_scalar_product_traits
{
...
{
    typedef typename ei_scalar_product_traits<typename ei_cleantype<ArgType0>::type,
                                              typename ei_cleantype<ArgType1>::type>::ReturnType type;
};
