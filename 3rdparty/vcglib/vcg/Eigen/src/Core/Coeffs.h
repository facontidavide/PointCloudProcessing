...
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::coeff(int row, int col) const
{
...
/** \returns the coefficient at given the given row and column.
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::operator()(int row, int col) const
{
...
/** Short version: don't use this function, use
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::coeffRef(int row, int col)
{
    ei_internal_assert(row >= 0 && row < rows() && col >= 0 && col < cols());
...
/** \returns a reference to the coefficient at given the given row and column.
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::operator()(int row, int col)
{
    ei_assert(row >= 0 && row < rows() && col >= 0 && col < cols());
    return derived().coeffRef(row, col);
}
...
/** Short version: don't use this function, use
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::coeff(int index) const
{
...
/** \returns the coefficient at given index.
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::operator[](int index) const
{
...
/** Short version: don't use this function, use
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::coeffRef(int index)
{
    ei_internal_assert(index >= 0 && index < size());
...
/** \returns a reference to the coefficient at given index.
  ...
  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::operator[](int index)
{
    ei_assert(index >= 0 && index < size());
    return derived().coeffRef(index);
}
...
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::x() const
{
    return (*this)[0];
}
...
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::y() const
{
    return (*this)[1];
}
...
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::z() const
{
    return (*this)[2];
}
...
template <typename Derived>
EIGEN_STRONG_INLINE const typename ei_traits<Derived>::Scalar MatrixBase<Derived>::w() const
{
    return (*this)[3];
}
...
/** equivalent to operator[](0).  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::x()
{
    return (*this)[0];
}
...
/** equivalent to operator[](1).  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::y()
{
    return (*this)[1];
}
...
/** equivalent to operator[](2).  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::z()
{
    return (*this)[2];
}
...
/** equivalent to operator[](3).  */
template <typename Derived>
EIGEN_STRONG_INLINE typename ei_traits<Derived>::Scalar& MatrixBase<Derived>::w()
{
    return (*this)[3];
}
...
{
    ei_internal_assert(row >= 0 && row < rows() && col >= 0 && col < cols());
    derived().template writePacket<StoreMode>(row, col, other.derived().template packet<LoadMode>(row, col));
}
