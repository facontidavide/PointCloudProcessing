...
template <typename CoeffsVectorType>
class DiagonalMatrix : ei_no_assignment_operator, public MatrixBase<DiagonalMatrix<CoeffsVectorType> >
{
  public:
...
inline const DiagonalMatrix<Derived> MatrixBase<Derived>::asDiagonal() const
{
    return derived();
}
