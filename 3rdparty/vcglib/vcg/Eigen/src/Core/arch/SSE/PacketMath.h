...
{
    return _mm_or_si128(_mm_and_si128(_mm_mul_epu32(a, b), _mm_setr_epi32(0xffffffff, 0, 0xffffffff, 0)),
                        _mm_slli_si128(_mm_and_si128(_mm_mul_epu32(_mm_srli_si128(a, 4), _mm_srli_si128(b, 4)),
...
template <>
EIGEN_STRONG_INLINE __m128i ei_pdiv<__m128i>(const __m128i& /*a*/, const __m128i& /*b*/)
{
