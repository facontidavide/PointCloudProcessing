...
#define USE_CONST_v0f                                                                                                  \
    USE_CONST_v0i;                                                                                                     \
    const v4f v0f = (v4f)v0i
#define USE_CONST_v1f                                                                                                  \
    USE_CONST_v1i;                                                                                                     \
    const v4f v1f = vec_ctf(v1i, 0)
#define USE_CONST_v1i_ const v4ui v1i_ = vec_splat_u32(-1)
#define USE_CONST_v0f_                                                                                                 \
    USE_CONST_v1i_;                                                                                                    \
    const v4f v0f_ = (v4f)vec_sl(v1i_, v1i_)
...
template <>
inline v4f ei_padd(const v4f& a, const v4f& b)
{
    return vec_add(a, b);
}
template <>
inline v4i ei_padd(const v4i& a, const v4i& b)
{
    return vec_add(a, b);
}

template <>
inline v4f ei_psub(const v4f& a, const v4f& b)
{
    return vec_sub(a, b);
}
template <>
inline v4i ei_psub(const v4i& a, const v4i& b)
{
    return vec_sub(a, b);
}

template <>
inline v4f ei_pmul(const v4f& a, const v4f& b)
{
    USE_CONST_v0f;
    return vec_madd(a, b, v0f);
}
template <>
inline v4i ei_pmul(const v4i& a, const v4i& b)
{
...
template <>
inline v4f ei_pdiv(const v4f& a, const v4f& b)
{
    v4f t, y_0, y_1, res;
    USE_CONST_v0f;
    USE_CONST_v1f;
...
template <>
inline v4f ei_pmadd(const v4f& a, const v4f& b, const v4f& c)
{
    return vec_madd(a, b, c);
}

template <>
inline v4f ei_pmin(const v4f& a, const v4f& b)
{
    return vec_min(a, b);
}
template <>
inline v4i ei_pmin(const v4i& a, const v4i& b)
{
    return vec_min(a, b);
}

template <>
inline v4f ei_pmax(const v4f& a, const v4f& b)
{
    return vec_max(a, b);
}
template <>
inline v4i ei_pmax(const v4i& a, const v4i& b)
{
    return vec_max(a, b);
}

template <>
inline v4f ei_pload(const float* from)
{
    return vec_ld(0, from);
}
template <>
inline v4i ei_pload(const int* from)
{
    return vec_ld(0, from);
}

template <>
inline v4f ei_ploadu(const float* from)
{
...
template <>
inline v4i ei_ploadu(const int* from)
{
    // Taken from http://developer.apple.com/hardwaredrivers/ve/alignment.html
    __vector unsigned char MSQ, LSQ;
    __vector unsigned char mask;
...
template <>
inline v4f ei_pset1(const float& from)
{
    // Taken from http://developer.apple.com/hardwaredrivers/ve/alignment.html
...
template <>
inline v4i ei_pset1(const int& from)
{
...
template <>
inline void ei_pstore(float* to, const v4f& from)
{
    vec_st(from, 0, to);
}
template <>
inline void ei_pstore(int* to, const v4i& from)
{
    vec_st(from, 0, to);
}

template <>
inline void ei_pstoreu(float* to, const v4f& from)
{
    // Taken from http://developer.apple.com/hardwaredrivers/ve/alignment.html
...
template <>
inline void ei_pstoreu(int* to, const v4i& from)
{
    // Taken from http://developer.apple.com/hardwaredrivers/ve/alignment.html
    // Warning: not thread safe!
    __vector unsigned char MSQ, LSQ, edges;
...
template <>
inline float ei_pfirst(const v4f& a)
{
    float __attribute__(aligned(16)) af[4];
    vec_st(a, 0, af);
    return af[0];
...
template <>
inline int ei_pfirst(const v4i& a)
{
    int __attribute__(aligned(16)) ai[4];
    vec_st(a, 0, ai);
    return ai[0];
