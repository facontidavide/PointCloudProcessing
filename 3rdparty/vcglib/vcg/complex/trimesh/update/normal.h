  ...
  public:
    ...
    */
    ...
    /**
     ...
     The weight for each wedge is the cross product of the two edge over the product of the square of the two edge
     lengths.
    ...
    */
    ...
    {
        if (!m.HasPerVertexNormal() || !m.HasPerFaceNormal())
            return;
