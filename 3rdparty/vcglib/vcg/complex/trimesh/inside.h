...
/// First parameter is a spatial indexing structure (eg. a grid) used to perform research operation, initialized with
/// faces of the triangular mesh of type TriMeshType
  ...
  public:
    ...
    static bool Is_Inside(TriMeshType &m, FaceSpatialIndexing &_g_mesh, const CoordType &test)
    {
        ...
        else
        {
            ...
            FaceType *f = vcg::tri::GetClosestFace<TriMeshType, FaceSpatialIndexing>(m, _g_mesh, test, m.bbox.Diag(),
                                                                                     dist, nearest, Norm, ip);
