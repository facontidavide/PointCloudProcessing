...
class Geo
{
  public:
    ...
    */
    ...
    static ScalarType Distance(const VertexPointer &pw, const VertexPointer &pw1, const VertexPointer &curr,
                               const ScalarType &d_pw1, const ScalarType &d_curr)
    {
        ScalarType curr_d = 0;
    ...
    /*
      ...
      wrapping function.
    */
    static VertexPointer Visit(MeshType &m, std::vector<VertDist> &_inputfrontier, ScalarType &max_distance,
                ...
                for (k = 0; k < 2; ++k)
                {
                    ...
                    const ScalarType &d_pw1 = (*TD)[pw1].d;
                    {
                        ...
                        if (((*TD)[pw1].source != (*TD)[curr].source) ||  // not the same source
                            (inter + d_curr < d_pw1 + tol) || (inter + d_pw1 < d_curr + tol) ||
  ...
  public:
    ...
    */
    static bool FarthestVertex(MeshType &m, std::vector<VertexPointer> &fro, VertexPointer &farthest,
                               ScalarType &distance,
                               typename MeshType::template PerVertexAttributeHandle<VertexPointer> *sources = NULL)
    {
    ...
    */
    ...
    /*
        ...
        Note: update the field Q() of the vertices
    */
    static void FarthestBVertex(MeshType &m, std::vector<VertexPointer> &fro, VertexPointer &farthest,
                                ScalarType &distance,
                                typename MeshType::template PerVertexAttributeHandle<VertexPointer> *sources = NULL)
    {
        typename std::vector<VertexPointer>::iterator fi;
    ...
    /*
        ...
        Note: update the field Q() of the vertices
    */
    static void FarthestBVertex(MeshType &m, VertexPointer seed, VertexPointer &farthest, ScalarType &distance,
                                typename MeshType::template PerVertexAttributeHandle<VertexPointer> *sources = NULL)
    {
        std::vector<VertexPointer> fro;
        fro.push_back(seed);
    ...
    /*
        ...
        Note: update the field Q() of the vertices
    */
    static bool DistanceFromBorder(MeshType &m, ScalarType &distance,
                                   typename MeshType::template PerVertexAttributeHandle<VertexPointer> *sources = NULL)
    {
        std::vector<VertexPointer> fro;
        VertexIterator vi;
