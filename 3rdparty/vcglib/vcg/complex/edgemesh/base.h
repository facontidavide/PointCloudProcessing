...
class EdgeMesh
{
  ...
  public:
    ...
    {
        return EdgeType::HasEdgeColor();
    }
    static bool HasPerEdgeNormal()
    {
        return EdgeType::HasEdgeNormal();
    }
    static bool HasPerEdgeMark()
    {
        return EdgeType::HasEdgeMark();
    }
    ...
    {
        return HasEETopology() || HasVETopology();
    }
    ...
    */
    inline bool IsMarked(ConstVertexPointer v) const
    {
        return v->IMark() == imark;
    }
    /** Check if the face incremental mark matches the one of the mesh.
    */
    inline bool IsMarked(ConstEdgePointer f) const
    {
        return f->IMark() == imark;
    }
    /** Set the vertex incremental mark of the vertex to the one of the mesh.
    */
    inline void Mark(VertexPointer v) const
    {
        v->IMark() = imark;
    }
    /** Set the face incremental mark of the vertex to the one of the mesh.
    */
    inline void Mark(EdgePointer f) const
    {
        f->IMark() = imark;
    }
    /// Unmark the mesh
