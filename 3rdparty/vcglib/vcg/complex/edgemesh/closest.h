...
unsigned int GetKClosestEdge(MESH &mesh, GRID &gr, const unsigned int _k, const typename GRID::CoordType &_p,
...
unsigned int GetInBoxEdge(MESH &mesh, GRID &gr, const vcg::Box3<typename GRID::ScalarType> _bbox,
