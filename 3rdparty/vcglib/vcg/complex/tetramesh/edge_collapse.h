    ...
    static bool _LinkConditionsF(PosType pos)
    {
        ...
        while (ti != _Sets().v0.end())
        {
            ...
            for (int f = 0; f < 3; f++)
            {
                ...
                {
                    orMarkF(Face((*ti)->V(Tetra::VofF(f_test, 0)), (*ti)->V(Tetra::VofF(f_test, 1)), &_DummyV()),
                            LINK_V0);
                    orMarkF(Face((*ti)->V(Tetra::VofF(f_test, 1)), (*ti)->V(Tetra::VofF(f_test, 2)), &_DummyV()),
                            LINK_V0);
                    orMarkF(Face((*ti)->V(Tetra::VofF(f_test, 2)), (*ti)->V(Tetra::VofF(f_test, 0)), &_DummyV()),
                            LINK_V0);
                }
            }
            ti++;
    ...
    static bool _LinkConditionsV()
    {
        ...
        while (ti != _Sets().v1.end())
        {
            ...
            if ((vt0->Flags() & LINK_V0) && (!(vt0->Flags() & LINK_EE)))
                correct = false;
            else if ((vt1->Flags() & LINK_V0) && (!(vt1->Flags() & LINK_EE)))
                correct = false;
            else if ((vt2->Flags() & LINK_V0) && (!(vt2->Flags() & LINK_EE)))
                correct = false;
            else if ((vt3->Flags() & LINK_V0) && (!(vt3->Flags() & LINK_EE)))
                correct = false;
  ...
  public:
    ...
    static bool CheckPreconditions(PosType pos, CoordType NewP)
    {
        ...
        //}
          ...
          if (!bordere)
            ...
            return ((_FlipCondition(pos, NewP)) && (_LinkConditionsV()) && (_LinkConditionsE(pos)) &&
                    (_LinkConditionsF(pos)));
        // return false;
    }
    ...
    static void FindSets(vcg::tetra::Pos<TetraType> pos)
    {
        ...
        while (!vf0.End())
        {
            ...
            if ((vf0.Vt()->V(0) != ve1) && (vf0.Vt()->V(1) != ve1) && (vf0.Vt()->V(2) != ve1) &&
                (vf0.Vt()->V(3) != ve1))
        ...
        while (!vf0.End())
        {
            ...
            _Sets().v0_U_v1.push_back(vf0.Vt());
            // set of union minus intersection
            if ((vf0.Vt()->V(0) != ve0) && (vf0.Vt()->V(1) != ve0) && (vf0.Vt()->V(2) != ve0) &&
                (vf0.Vt()->V(3) != ve0))
                _Sets().no_E.push_back(vf0.Vt());
            ++vf0;
        }
