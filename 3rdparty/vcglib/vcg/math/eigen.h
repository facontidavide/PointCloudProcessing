...
template <typename Derived1, typename Derived2, int Size>
struct ei_lexi_comparison;

template <typename Derived1, typename Derived2, bool SameType = ei_is_same_type<Derived1, Derived2>::ret,
          bool SameSize = Derived1::SizeAtCompileTime == Derived2::SizeAtCompileTime>
struct ei_import_selector;

template <typename XprType, int Rows = ei_traits<XprType>::RowsAtCompileTime,
          int Cols = ei_traits<XprType>::ColsAtCompileTime, int StorageOrder = ei_traits<XprType>::Flags & 1,
          int MRows = ei_traits<XprType>::MaxRowsAtCompileTime, int MCols = ei_traits<XprType>::MaxColsAtCompileTime>
...
struct NumTraits
{
    struct wrong_type
    {
        wrong_type()
        {
            assert(0 && "Eigen: you are using a wrong scalar type");
        }
    };
...
struct ei_lexi_comparison<Derived1, Derived2, 3>
{
    inline static bool less(const Derived1& a, const Derived2& b)
    {
        return (a.coeff(2) != b.coeff(2)) ? (a.coeff(2) < b.coeff(2)) : (a.coeff(1) != b.coeff(1)) ?
                                            (a.coeff(1) < b.coeff(1)) :
                                            (a.coeff(0) < b.coeff(0));
    }
...
struct ei_lexi_comparison<Derived1, Derived2, 4>
{
    inline static bool less(const Derived1& a, const Derived2& b)
    {
        return (a.coeff(3) != b.coeff(3)) ? (a.coeff(3) < b.coeff(3)) : (a.coeff(2) != b.coeff(2)) ?
                                            (a.coeff(2) < b.coeff(2)) :
                                            (a.coeff(1) != b.coeff(1)) ? (a.coeff(1) < b.coeff(1)) :
                                                                         (a.coeff(0) < b.coeff(0));
    }
...
struct ei_to_vcgtype
{
    typedef Matrix<typename XprType::Scalar, Rows, Cols, StorageOrder, MRows, MCols> type;
};
}
...
#define VCG_EIGEN_INHERIT_ASSIGNMENT_OPERATOR(Derived, Op)                                                             \
    ...
    {                                                                                                                  \
        Base::operator Op(other.derived());                                                                            \
        return *this;                                                                                                  \
    }                                                                                                                  \
    Derived& operator Op(const Derived& other)                                                                         \
    {                                                                                                                  \
        Base::operator Op(other);                                                                                      \
        return *this;                                                                                                  \
    }
...
{
template <typename Derived1, typename Derived2>
typename Eigen::ei_traits<Derived1>::Scalar Angle(const Eigen::MatrixBase<Derived1>& p1,
...
template <typename Derived1, typename Derived2>
typename Eigen::ei_traits<Derived1>::Scalar AngleN(const Eigen::MatrixBase<Derived1>& p1,
                                                   const Eigen::MatrixBase<Derived2>& p2)
{
    EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived1)
    EIGEN_STATIC_ASSERT_VECTOR_ONLY(Derived2)
...
template <typename Derived1, typename Derived2>
inline typename Eigen::ei_traits<Derived1>::Scalar Distance(const Eigen::MatrixBase<Derived1>& p1,
                                                            const Eigen::MatrixBase<Derived2>& p2)
{
    return (p1 - p2).norm();
}
...
template <typename Derived1, typename Derived2>
inline typename Eigen::ei_traits<Derived1>::Scalar SquaredDistance(const Eigen::MatrixBase<Derived1>& p1,
                                                                   const Eigen::MatrixBase<Derived2>& p2)
{
...
template <typename Derived>
inline const Eigen::CwiseBinaryOp<Eigen::ei_scalar_max_op<typename Eigen::ei_traits<Derived>::Scalar>, Derived,
