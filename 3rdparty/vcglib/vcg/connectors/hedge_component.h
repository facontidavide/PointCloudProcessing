...
//  inline typename T::VertexType *       & V( const int j ) 	    {	assert(0);		static typename
...
/*----------------------------- HVADJ ------------------------------*/
template <class T>
class EmptyHVAdj : public T
{
  public:
    typename T::VertexPointer &HVp()
    {
        static typename T::VertexPointer ep = 0;
        assert(0);
        return ep;
    }
    const typename T::VertexPointer cHVp() const
    {
        static typename T::VertexPointer ep = 0;
        assert(0);
        return ep;
    ...
    static bool HasHVAdjacency()
    {
        return false;
    }
    static bool HasHVAdjacencyOcc()
    {
        return false;
    }
    static void Name(std::vector<std::string> &name)
...
class HVAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HVAdj"));
        T::Name(name);
    }
...
/*----------------------------- HEADJ ------------------------------*/
template <class T>
class EmptyHEAdj : public T
{
  public:
    typename T::EdgePointer &HEp()
    {
        static typename T::EdgePointer ep = 0;
        assert(0);
        return ep;
    }
    const typename T::EdgePointer cHEp() const
    {
        static typename T::EdgePointer ep = 0;
        assert(0);
        return ep;
    ...
    static bool HasHEAdjacency()
    {
        return false;
    }
    static bool HasHEAdjacencyOcc()
    {
        return false;
    }
    static void Name(std::vector<std::string> &name)
...
class HEAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HEAdj"));
        T::Name(name);
    }
...
/*----------------------------- HHADJ ------------------------------*/
template <class T>
class EmptyHHAdj : public T
{
  public:
    typename T::HEdgePointer &HHp(const int &)
    {
        static typename T::EdgePointer ep = 0;
        assert(0);
        return ep;
    }
    typename T::HEdgePointer cHHp(const int &)
    {
        static typename T::EdgePointer ep = 0;
        assert(0);
        return ep;
...
class HHAdj : public T
{
  public:
    ...
    typename T::EdgePointer &HHp(const int &i)
    {
        return _ep[i];
    }
    typename T::EdgePointer cHHp(const int &i)
    {
        return _ep[i];
    }
    int &HHi(const int &i)
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HHAdj"));
        T::Name(name);
    }
...
/*----------------------------- HENextADJ ------------------------------*/
template <class T>
class EmptyHNextAdj : public T
{
  public:
    typename T::HEdgePointer &HNp()
    {
        static typename T::HEdgePointer ep = 0;
        assert(0);
        return ep;
    }
    typename T::HEdgePointer const cHNp() const
    {
        static typename T::HEdgePointer ep = 0;
        assert(0);
        return ep;
    ...
    static bool HasHNextAdjacency()
    {
        return false;
    }
    static bool HasHNextAdjacencyOcc()
    {
        return false;
    }
    static void Name(std::vector<std::string> &name)
...
class HNextAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HNextAdj"));
        T::Name(name);
    }
...
/*----------------------------- HEOppADJ ------------------------------*/
template <class T>
class EmptyHOppAdj : public T
{
  public:
    typename T::HEdgePointer &HOp()
    {
        static typename T::HEdgePointer ep = 0;
        assert(0);
        return ep;
    }
    typename T::HEdgePointer const cHOp() const
    {
        static typename T::HEdgePointer ep = 0;
        assert(0);
        return ep;
    ...
    static bool HasHOpptAdjacencyOcc()
    {
        return false;
    }
    static void Name(std::vector<std::string> &name)
...
class HOppAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HOppAdj"));
        T::Name(name);
    }
...
/*----------------------------- HPrevADJ ------------------------------*/
template <class T>
class EmptyHPrevAdj : public T
{
  public:
    typename T::HEdgePointer &HPp()
    {
        static typename T::HEdgePointer ep = 0;
        assert(0);
        return ep;
    }
    typename T::HEdgePointer const cHPp() const
    {
        static typename T::HEdgePointer ep = 0;
        assert(0);
        return ep;
...
class HPrevAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HPrevAdj"));
        T::Name(name);
    }
...
template <class T>
class EmptyHFAdj : public T
{
  public:
    typename T::FacePointer &HFp()
    {
        static typename T::FacePointer fp = 0;
        assert(0);
        return fp;
    }
    typename T::FacePointer const cHFp() const
    {
        static typename T::FacePointer fp = 0;
        assert(0);
        return fp;
...
class HFAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("HFAdj"));
        T::Name(name);
    }
                            ...
                            T> > > > >
{
  public:
    ...
    typename T::VertexPointer &Vertex()
    {
        return this->HVp();
    }
    const typename T::VertexPointer &cVertex() const
    {
        return this->cHVp();
    }
    typename T::HEdgePointer Opposite()
    {
        return this->HOp();
    }
    const typename T::HEdgePointer &cOpposite() const
    {
        return this->cHOp();
    }
    typename T::HEdgePointer &Next()
    {
        return this->HNp();
    }
    const typename T::HEdgePointer &cNext() const
    {
        return this->HNp();
    }
};
