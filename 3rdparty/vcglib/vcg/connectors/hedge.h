...
*/
template <class UserTypes>
class HEdgeBase : public hedge::EmptyHEdgeData<hedge::EmptyBitFlags<HEdgeTypeHolder<UserTypes> > >
{
};
...
template <class UserTypes, template <typename> class A, template <typename> class B, template <typename> class C,
          ...
          template <typename> class J, template <typename> class K>
...
{
  public:
    typedef AllTypes::AHEdgeType IAm;
