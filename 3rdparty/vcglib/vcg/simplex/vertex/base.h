...
Removed spurious definition of flags in Aritymax that was overriding the correct definition in EmplyBitFlags and
BitFlags classes
...
template <class UserTypes, template <typename> class A, template <typename> class B, template <typename> class C,
          ...
          template <typename> class J, template <typename> class K, template <typename> class L>
