...
template <class UserTypes>
class FaceBase
  : public face::EmptyPolyInfo<face::EmptyVertexRef<face::EmptyAdj<face::EmptyColorMarkQuality<
      face::EmptyNormal<face::EmptyBitFlags<face::EmptyWedgeTexCoord<FaceTypeHolder<UserTypes> > > > > > > >
{
};
...
template <class UserTypes, template <typename> class A, template <typename> class B, template <typename> class C,
          template <typename> class D, template <typename> class E, template <typename> class F,
          template <typename> class G, template <typename> class H, template <typename> class I,
...
class FaceArityMax : public J<Arity9<FaceBase<UserTypes>, A, B, C, D, E, F, G, H, I> >
{
  public:
    ...
    */
    ...
    {
        return (this->Flags() & (FAUX0 << i)) != 0;
    }
    bool IsAnyF() const
    {
        return (this->Flags() & (FAUX0 | FAUX1 | FAUX2)) != 0;
    }
    /// This function select the face
    void SetF(int i)
    {
...
template <class UserTypes, template <typename> class A = DefaultDeriver, template <typename> class B = DefaultDeriver,
