...
class WedgeTexCoordOcc : public T
{
  public:
    ...
    {
        return CAT<vector_occ<FaceType>, WedgeTexCoordType>::Instance()->Get((FaceType *)this);
    }
...
template <class T>
class WedgeTexCoordfOcc : public WedgeTexCoordOcc<TexCoord2<float, 1>, T>
{
};
...
class InfoOccBase : public T
{
  public:
    ...
    InfoType &N()
    {
        return CAT<vector_occ<FaceType>, InfoType>::Instance()->Get((FaceType *)this);
    }
    static bool HasInfo()
    {
        return true;
...
template <class T>
class InfoOcc : public InfoOccBase<int, T>
{
};
...
class NormalOcc : public T
{
  public:
    ...
    NormalType &N()
    {
        return CAT<vector_occ<FaceType>, NormalType>::Instance()->Get((FaceType *)this);
    }
...
class MarkOcc : public T
{
  public:
    ...
    int &IMark()
    {
        return CAT<vector_occ<FaceType>, MarkType>::Instance()->Get((MarkType *)this);
    }
...
class ColorOcc : public T
{
  public:
    ...
    ColorType &C()
    {
        return CAT<vector_occ<FaceType>, ColorType>::Instance()->Get((FaceType *)this);
    }
...
class VFAdjOccBase : public T
{
  public:
    ...
    {
        return (CAT<vector_occ<FaceType>, VFAdjTypeSup<FacePointer> >::Instance()->Get((FaceType *)this))._vfi[j];
    }
...
template <class T>
class VFAdjOcc : public VFAdjOccBase<VFAdjTypeSup<typename T::FacePointer>, T>
{
};
...
template <class T>
class FFAdjOcc : public FFAdjOccBase<FFAdjTypeSup<typename T::FacePointer>, T>
{
};

template <class T>
class VertexRefOcc : public T
{
  public:
