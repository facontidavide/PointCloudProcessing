...
/*-------------------------- PolInfo -------------------------------------------*/
template <class T>
class EmptyPolyInfo : public T
{
  protected:
    inline void SetVN(const int &n)
    {
        assert(0);
    }
...
class PolyInfo : public T
{
  ...
  public:
    ...
    */
    ...
    // EmptyPFHAdj
    typename T::HEdgePointer &FHp(const int &)
    {
        static typename T::HEdgePointer fp = 0;
        assert(0);
        return fp;
    }
    typename T::HEdgePointer const cFHp(const int &) const
    {
        static typename T::HEdgePointer const fp = 0;
        return fp;
    }
...
class PFVAdj : public T
{
  public:
     ...
     */
    inline VertexType *&V0(const int j)
    {
        return V(j);
    }
    inline VertexType *&V1(const int j)
    {
        return V((j + 1) % this->VN());
    }
    inline VertexType *&V2(const int j)
    {
        return V((j + 2) % this->VN());
    }
    inline const VertexType *const &V0(const int j) const
    {
        return V(j);
    }
    inline const VertexType *const &V1(const int j) const
    {
        return V((j + 1) % this->VN());
    }
    inline const VertexType *const &V2(const int j) const
    {
        return V((j + 2) % this->VN());
    }
    inline const VertexType *const &cV0(const int j) const
    {
        return cV(j);
    }
    inline const VertexType *const &cV1(const int j) const
    {
        return cV((j + 1) % this->VN());
    }
    inline const VertexType *const &cV2(const int j) const
    {
        return cV((j + 2) % this->VN());
    }
    ...
    {
        return V((j + 1) % this->VN())->P();
    }
    inline CoordType &P2(const int j)
    {
        return V((j + 2) % this->VN())->P();
    }
    ...
    {
        return cV((j + 1) % this->VN())->P();
    }
    inline const CoordType &cP2(const int j) const
    {
        return cV((j + 2) % this->VN())->P();
    }
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("PFVAdj"));
        T::Name(name);
    }
...
class PVFAdj : public T
{
  public:
    ...
    */
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("PVFAdj"));
        T::Name(name);
    }
...
class PFFAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("PFFAdj"));
        T::Name(name);
    }
...
class PFEAdj : public T
{
  public:
    ...
    typename T::EdgePointer &FEp(const int j)
    {
        assert(j >= 0 && j < this->VN());
        return _fepP[j];
    }
    typename T::EdgePointer const FEp(const int j) const
    {
        assert(j >= 0 && j < this->VN());
        return _fepP[j];
    }
    typename T::EdgePointer const cFEp(const int j) const
    {
        assert(j >= 0 && j < this->VN());
        return _fepP[j];
    }
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("PFEAdj"));
        T::Name(name);
    }
...
class PFHAdj : public T
{
  public:
    ...
    static void Name(std::vector<std::string> &name)
    {
        name.push_back(std::string("PFHAdj"));
        T::Name(name);
    }
