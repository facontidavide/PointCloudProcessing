...
class Pos
{
  public:
    ...
    /// Operator to order half-edge; it's compare at the first the face pointers, then the index of the edge and finally
    /// the vertex pointers
    inline bool operator<=(PosType const &p) const
    {
...
class VFIterator
{
  public:
    ...
    // vfi.V() = vfi.F()->V(vfi.I())
    inline VertexType *V() const
    {
        return f->V(z);
    }

    inline VertexType *const &V0() const
    {
        return f->V0(z);
    }
    inline VertexType *const &V1() const
    {
        return f->V1(z);
    }
    inline VertexType *const &V2() const
    {
        return f->V2(z);
    }
