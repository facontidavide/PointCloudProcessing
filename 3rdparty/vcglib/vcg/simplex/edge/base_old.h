...
Major rewriting of the whole class edge. Removed default flags and nonsense attibutes. Given consistent naming to
defines.
...
class EDGE_TYPE
{
  public:
    ...
    inline EDGE_TYPE(VertexType* v0, VertexType* v1)
    {
        v[0] = v0;
        v[1] = v1;
    }
    ...
    {
        if (v0 < v1)
            return EDGE_TYPE(v0, v1);
        else
            return EDGE_TYPE(v1, v0);
    }

    /// Costructor
    inline void Set(VertexType* v0, VertexType* v1)
    {
        v[0] = v0;
        v[1] = v1;
    }
  ...
  public:
    ...
    /** Return the pointer to the ((j+1)%3)-th vertex of the face.
        @param j Index of the face vertex.
     */
    inline SVTYPE*& V0(const int j)
    {
        return V(j);
    }
    inline SVTYPE*& V1(const int j)
    {
        return V((j + 1) % 2);
    }
    inline const SVTYPE* const& V0(const int j) const
    {
        return V(j);
    }
    inline const SVTYPE* const& V1(const int j) const
    {
        return V((j + 1) % 2);
    }
    inline const SVTYPE* const& cV0(const int j) const
    {
        return cV(j);
    }
    inline const SVTYPE* const& cV1(const int j) const
    {
        return cV((j + 1) % 2);
    }
...
//@{
  ...
  public:
    ...
    inline const EDGENAME* const& EEp1(const int j) const
    {
        return EEp((j + 1) % 2);
    }
...
/// This are the _flags of face, the default value is 0
  ...
  public:
    ...
    **/
    ...
    {
        if ((V(0) != f.V(0)) && (V(0) != f.V(1)))
            return false;
        if ((V(1) != f.V(0)) && (V(1) != f.V(1)))
            return false;
        return true;
    }
