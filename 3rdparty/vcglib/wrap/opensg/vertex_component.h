...
class OSGInfo : public T
{
  ...
  private:
    OSG::GeometryPtr _geop;  /// Maybe we can use pointers to buffers directly but now we really don't now if these
                             /// pointers change in time ... !!!
...
class OSGCoord : public T
{
  public:
    typedef A CoordType;  /// Must be a OSG::Pnt3 type as : OSG::Pnt3s, OSG:Pnt3f, OSG::Pnt3d etc...
    typedef typename CoordType::ValueType ScalarType;  /// Can be a OSG basic type as : OSG::Int16, OSG::Real32,
                                                       /// OSG::Real64 etc...
    ...
    static void Name(std::vector<std::string>& name)
    {
        name.push_back(std::string("OSGCoord"));
        T::Name(name);
    }
...
template <class T>
class OSGCoord3f : public OSGCoord<OSG::Pnt3f, T>
{
  public:
    static void Name(std::vector<std::string>& name)
    {
        name.push_back(std::string("OSGCoord3f"));
        T::Name(name);
    }
};
...
template <class A, class T>
class OSGNormal : public T
{
  public:
    typedef A NormalType;  /// Must be a OSG::Vec3 type as : OSG::Vec3s, OSG:Vec3f, OSG::Vec3d etc...
    typedef typename NormalType::ValueType ScalarType;  /// Can be a OSG basic type as : OSG::Int16, OSG::Real32,
                                                        /// OSG::Real64 etc...
    ...
    static void Name(std::vector<std::string>& name)
    {
        name.push_back(std::string("OSGNormal"));
        T::Name(name);
    }
...
template <class T>
class OSGNormal3f : public OSGNormal<OSG::Vec3f, T>
{
  public:
    static void Name(std::vector<std::string>& name)
    {
        name.push_back(std::string("OSGNormal3f"));
        T::Name(name);
    }
};
...
class OSGColor : public T
{
  public:
    ...
    static void Name(std::vector<std::string>& name)
    {
        name.push_back(std::string("OSGColor"));
        T::Name(name);
    }
...
template <class T>
class OSGColor3f : public OSGColor<OSG::Color3f, T>
{
    static void Name(std::vector<std::string>& name)
    {
        name.push_back(std::string("OSGColor3f"));
        T::Name(name);
    }
};
