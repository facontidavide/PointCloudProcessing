...
class AxisMode : public TrackMode
{
  public:
    ...
    */
    AxisMode(const Line3f &ln) : axis(ln)
    {
    }
    /*!
    ...
    */
    AxisMode(const Point3f &origin, const Point3f &direction) : axis(Line3fN(origin, direction))
    {
    }
    /*!
      @brief Return this manipulator's name.
...
class PlaneMode : public TrackMode
{
  public:
    ...
    */
    PlaneMode(float a, float b, float c, float d) : plane(Plane3f(d, Point3f(a, b, c)))
    {
    }
    /*!
...
class CylinderMode : public TrackMode
{
  public:
    ...
    */
    CylinderMode(Line3fN &ln, float s = 0.0f) : axis(ln), snap(s)
    {
        assert(snap >= 0.0);
    }
    /*!
...
class PathMode : public TrackMode
{
  public:
    /*!
      ...
      @warning the path is \b not assumed to have 0-length segments, so, if you want to close the path, please <b>do
      not</b> add  a copy of the first point on the end of the vector.
...
class AreaMode : public TrackMode
{
  public:
    /*!
      ...
      @warning The polygon is \b not assumed to have 0-length sides, so please <b>do not</b> add a copy of the first
      point on the end of the vector.
