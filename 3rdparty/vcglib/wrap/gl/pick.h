...
class GLPickTri
{
  ...
  public:
    ...
    static int PickFaceVisible(int x, int y, MESH_TYPE &m, std::vector<FacePointer> &resultZ, int width = 4,
                               int height = 4, bool sorted = true)
    {
        // First step
...
class GLPickTetra
{
  ...
  public:
    ...
    static int PickTetra(int x, int y, TETRA_MESH_TYPE &m, std::vector<TetraPointer> &result, int width = 4,
                         int height = 4)
    {
        result.clear();
        long hits;
    ...
    static bool PickNearestTetraFace(int x, int y, TETRA_MESH_TYPE &m, TetraIterator &ti, int &face, int width = 4,
                                     int height = 4)
    {
    ...
    static int PickTetraFace(int x, int y, TETRA_MESH_TYPE &m, std::vector<std::pair<TetraPointer, int> > &result,
