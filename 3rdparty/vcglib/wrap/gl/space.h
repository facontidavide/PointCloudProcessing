...
struct EvalToKnownPointType<Derived, 2, 1>
{
    typedef Point2<typename Derived::Scalar> Type;
};

template <typename Derived>
struct EvalToKnownPointType<Derived, 3, 1>
{
    typedef Point3<typename Derived::Scalar> Type;
};

template <typename Derived>
struct EvalToKnownPointType<Derived, 4, 1>
{
    typedef Point4<typename Derived::Scalar> Type;
};

#define _WRAP_EIGEN_XPR(FUNC)                                                                                          \
    template <typename Derived>                                                                                        \
...
inline void glScale(float const& p)
{
    glScalef(p, p, p);
}
inline void glScale(double const& p)
{
    glScaled(p, p, p);
}

template <typename T>
inline void glVertex(const Eigen::Matrix<T, 2, 1>& p)
{
    assert(0);
}
template <>
inline void glVertex(const Eigen::Matrix<int, 2, 1>& p)
{
    glVertex2iv((const GLint*)p.data());
}
template <>
inline void glVertex(const Eigen::Matrix<short, 2, 1>& p)
{
    glVertex2sv(p.data());
}
template <>
inline void glVertex(const Eigen::Matrix<float, 2, 1>& p)
{
    glVertex2fv(p.data());
}
template <>
inline void glVertex(const Eigen::Matrix<double, 2, 1>& p)
{
    glVertex2dv(p.data());
}

template <typename T>
inline void glTexCoord(const Eigen::Matrix<T, 2, 1>& p)
{
    assert(0);
}
template <>
inline void glTexCoord(const Eigen::Matrix<int, 2, 1>& p)
{
    glTexCoord2iv((const GLint*)p.data());
}
template <>
inline void glTexCoord(const Eigen::Matrix<short, 2, 1>& p)
{
    glTexCoord2sv(p.data());
}
template <>
inline void glTexCoord(const Eigen::Matrix<float, 2, 1>& p)
{
    glTexCoord2fv(p.data());
}
template <>
inline void glTexCoord(const Eigen::Matrix<double, 2, 1>& p)
{
    glTexCoord2dv(p.data());
}

template <typename T>
inline void glTranslate(const Eigen::Matrix<T, 2, 1>& p)
{
    assert(0);
}
template <>
inline void glTranslate(const Eigen::Matrix<float, 2, 1>& p)
{
    glTranslatef(p[0], p[1], 0);
}
template <>
inline void glTranslate(const Eigen::Matrix<double, 2, 1>& p)
{
    glTranslated(p[0], p[1], 0);
}

template <typename T>
inline void glScale(const Eigen::Matrix<T, 2, 1>& p)
{
    assert(0);
}
template <>
inline void glScale(const Eigen::Matrix<float, 2, 1>& p)
{
    glScalef(p[0], p[1], 1.f);
}
template <>
inline void glScale(const Eigen::Matrix<double, 2, 1>& p)
{
    glScaled(p[0], p[1], 1.0);
}

template <typename T>
inline void glVertex(const Eigen::Matrix<T, 3, 1>& p)
{
    assert(0);
}
template <>
inline void glVertex(const Eigen::Matrix<int, 3, 1>& p)
{
    glVertex3iv((const GLint*)p.data());
}
template <>
inline void glVertex(const Eigen::Matrix<short, 3, 1>& p)
{
    glVertex3sv(p.data());
}
template <>
inline void glVertex(const Eigen::Matrix<float, 3, 1>& p)
{
    glVertex3fv(p.data());
}
template <>
inline void glVertex(const Eigen::Matrix<double, 3, 1>& p)
{
    glVertex3dv(p.data());
}

template <typename T>
inline void glNormal(const Eigen::Matrix<T, 3, 1>& p)
{
    assert(0);
}
template <>
inline void glNormal(const Eigen::Matrix<int, 3, 1>& p)
{
    glNormal3iv((const GLint*)p.data());
}
template <>
inline void glNormal(const Eigen::Matrix<short, 3, 1>& p)
{
    glNormal3sv(p.data());
}
template <>
inline void glNormal(const Eigen::Matrix<float, 3, 1>& p)
{
    glNormal3fv(p.data());
}
template <>
inline void glNormal(const Eigen::Matrix<double, 3, 1>& p)
{
    glNormal3dv(p.data());
}

template <typename T>
inline void glTexCoord(const Eigen::Matrix<T, 3, 1>& p)
{
    assert(0);
}
template <>
inline void glTexCoord(const Eigen::Matrix<int, 3, 1>& p)
{
    glTexCoord3iv((const GLint*)p.data());
}
template <>
inline void glTexCoord(const Eigen::Matrix<short, 3, 1>& p)
{
    glTexCoord3sv(p.data());
}
template <>
inline void glTexCoord(const Eigen::Matrix<float, 3, 1>& p)
{
    glTexCoord3fv(p.data());
}
template <>
inline void glTexCoord(const Eigen::Matrix<double, 3, 1>& p)
{
    glTexCoord3dv(p.data());
}

template <typename T>
inline void glTranslate(const Eigen::Matrix<T, 3, 1>& p)
{
    assert(0);
}
template <>
inline void glTranslate(const Eigen::Matrix<float, 3, 1>& p)
{
    glTranslatef(p[0], p[1], p[2]);
}
template <>
inline void glTranslate(const Eigen::Matrix<double, 3, 1>& p)
{
    glTranslated(p[0], p[1], p[2]);
}

template <typename T>
inline void glScale(const Eigen::Matrix<T, 3, 1>& p)
{
    assert(0);
}
template <>
inline void glScale(const Eigen::Matrix<float, 3, 1>& p)
{
    glScalef(p[0], p[1], p[2]);
}
template <>
inline void glScale(const Eigen::Matrix<double, 3, 1>& p)
{
    glScaled(p[0], p[1], p[2]);
}

inline void glColor(Color4b const& c)
{
    glColor4ubv(c.data());
}
inline void glClearColor(Color4b const& c)
{
    ::glClearColor(float(c[0]) / 255.0f, float(c[1]) / 255.0f, float(c[2]) / 255.0f, 1.0f);
}
inline void glLight(GLenum light, GLenum pname, Color4b const& c)
{
    static float cf[4];
    cf[0] = float(cf[0] / 255.0);
    cf[1] = float(c[1] / 255.0);
    cf[2] = float(c[2] / 255.0);
    cf[3] = float(c[3] / 255.0);
...
inline void glPlane3(Plane3<T> p, Point3<T> c, T size)
{
    ...
    Matrix44<T> m;
    *(Point3<T>*)&m[0][0] = *(Point3<T>*)&u[0];
    m[0][3] = 0;
    *(Point3<T>*)&m[1][0] = *(Point3<T>*)&w[0];
    m[1][3] = 0;
    *(Point3<T>*)&m[2][0] = *(Point3<T>*)&v[0];
    m[2][3] = 0;
    *(Point3<T>*)&m[3][0] = *(Point3<T>*)&c1[0];
    m[3][3] = 1;
