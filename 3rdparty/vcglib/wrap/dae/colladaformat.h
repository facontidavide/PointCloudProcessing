...
{
  public:
    ContributorTag() : XMLTag("contributor")
    {
    }
};
...
{
  public:
    AuthoringToolTag() : XMLLeafTag("authoring_tool")
    {
...
{
  public:
    UpAxisTag(const QString& up = "Y_UP") : XMLLeafTag("up_axis")
    {
        _text.push_back(up);
    }
};
...
{
  public:
    LibraryImagesTag() : XMLTag("library_images")
    {
    }
};
...
{
  public:
    ImageTag(const QString& id, const QString& name) : XMLTag("image")
    {
...
{
  public:
    InitFromTag(const QString& txtpathname) : XMLLeafTag("init_from")
    {
...
{
  public:
    LibraryMaterialsTag() : XMLTag("library_materials")
    {
    }
};
...
{
  public:
    MaterialTag(const QString& id, const QString& name) : XMLTag("material")
    {
        _attributes.push_back(TagAttribute("id", id));
        _attributes.push_back(TagAttribute("name", name));
    }
...
{
  public:
    InstanceEffectTag(const QString& url) : XMLLeafTag("instance_effect")
    {
...
{
  public:
    LibraryEffectsTag() : XMLTag("library_effects")
    {
    }
};
...
{
  public:
    EffectTag(const QString& id) : XMLTag("effect")
    {
        _attributes.push_back(TagAttribute("id", id));
    }
};
...
{
  public:
    ProfileCommonTag() : XMLTag("profile_COMMON")
    {
    }
};
...
{
  public:
    NewParamTag(const QString& sid) : XMLTag("newparam")
    {
...
{
  public:
    SurfaceTag(const QString& type = QString("2D")) : XMLTag("surface")
    {
...
{
  public:
    FormatTag(const QString& format) : XMLLeafTag("format")
    {
...
{
  public:
    SourceTag(const QString& id, const QString& name) : XMLLeafTag("source")
    {
        _attributes.push_back(TagAttribute("id", id));
        _attributes.push_back(TagAttribute("name", name));
    }

    SourceTag(const QString& source) : XMLLeafTag("source")
    {
...
{
  public:
    MinFilterTag(const QString& filter) : XMLLeafTag("minfilter")
    {
...
{
  public:
    MagFilterTag(const QString& filter) : XMLLeafTag("magfilter")
    {
        _text.push_back(filter);
    }
};
...
{
  public:
    TechniqueTag(const QString& sid) : XMLTag("technique")
    {
        _attributes.push_back(TagAttribute("sid", sid));
    }
};
...
{
  public:
    TechniqueCommonTag() : XMLTag("technique_common")
    {
    }
};
...
{
  public:
    ColorTag(const float r, const float g, const float b, const float a) : XMLLeafTag("color")
    {
...
{
  public:
    TextureTag(const QString& texture, const QString& texcoord) : XMLLeafTag("texture")
    {
...
{
  public:
    FloatTag(const float floatnum) : XMLLeafTag("float")
    {
...
{
  public:
    ReflectiveTag() : XMLTag("reflective")
    {
    }
};
...
{
  public:
    ReflectivityTag() : XMLTag("reflectivity")
    {
    }
};
...
{
  public:
    TransparentTag() : XMLTag("transparent")
    {
    }
};
...
{
  public:
    TransparencyTag() : XMLTag("transparency")
    {
    }
};
...
{
  public:
    IndexOfRefractionTag() : XMLTag("index_of_refraction")
    {
    }
};
...
{
  public:
    LibraryGeometriesTag() : XMLTag("library_geometries")
    {
    }
};
...
{
  public:
    GeometryTag(const QString& id, const QString& name) : XMLTag("geometry")
    {
        _attributes.push_back(TagAttribute("id", id));
        _attributes.push_back(TagAttribute("name", name));
    }
...
{
  public:
    ArraySourceTag(const QString& id, const QString& name) : XMLTag("source")
    {
        _attributes.push_back(TagAttribute("id", id));
        _attributes.push_back(TagAttribute("name", name));
    }
...
class FloatArrayTag : public XMLLeafTag
{
  public:
    ...
    FloatArrayTag(const QString& id, const int count, const MESHTYPE& m, ARRAYSEMANTIC sem,
                  const unsigned int componenttype)
...
{
  public:
    AccessorTag(const int count, const QString& source, const int stride) : XMLTag("accessor")
    {
        _attributes.push_back(TagAttribute("count", QString::number(count)));
...
{
  public:
    ParamTag(const QString& name, const QString& type) : XMLTag("param")
    {
        _attributes.push_back(TagAttribute("name", name));
        _attributes.push_back(TagAttribute("type", type));
    }
...
{
  public:
    VerticesTag(const QString& id) : XMLTag("vertices")
    {
        _attributes.push_back(TagAttribute("id", id));
    }
};
...
{
  public:
    InputTag(const QString& semantic, const QString& source) : XMLTag("input")
    {
        _attributes.push_back(TagAttribute("semantic", semantic));
        _attributes.push_back(TagAttribute("source", testSharp(source)));
    }

    InputTag(const int offset, const QString& semantic, const QString& source) : XMLTag("input")
    {
...
{
  public:
    TrianglesTag(const int count) : XMLTag("triangles")
    {
        _attributes.push_back(TagAttribute("count", QString::number(count)));
    }

    TrianglesTag(const int count, const QString& material) : XMLTag("triangles")
    {
        _attributes.push_back(TagAttribute("count", QString::number(count)));
...
class PTag : public XMLLeafTag
{
  public:
    template <typename MESHTYPE>
    PTag(const MESHTYPE& m, const unsigned int nedge, bool norm = false, bool texcoord = false) : XMLLeafTag("p")
    {
        int cont = 0;
    ...
    template <typename MESHTYPE>
    PTag(const MESHTYPE& m, const unsigned int nedge, QVector<int>& patchfaces, bool norm = false,
         bool texcoord = false)
        : XMLLeafTag("p")
    {
        int cont = 0;
...
{
  public:
    LibraryVisualScenesTag() : XMLTag("library_visual_scenes")
    {
    }
};
...
{
  public:
    VisualSceneTag(const QString& id, const QString& name) : XMLTag("visual_scene")
    {
        _attributes.push_back(TagAttribute("id", id));
        _attributes.push_back(TagAttribute("name", name));
    }
...
{
  public:
    NodeTag(const QString& id, const QString& name) : XMLTag("node")
    {
        _attributes.push_back(TagAttribute("id", id));
        _attributes.push_back(TagAttribute("name", name));
    }
...
{
  public:
    RotateTag(const QString& sid, const vcg::Point4f& p) : XMLLeafTag("rotate")
    {
        _attributes.push_back(TagAttribute("sid", sid));
...
{
  public:
    TranslateTag(const QString& sid, const vcg::Point4f& p) : XMLLeafTag("translate")
    {
        _attributes.push_back(TagAttribute("sid", sid));
...
{
  public:
    InstanceGeometryTag(const QString& url) : XMLTag("instance_geometry")
    {
        _attributes.push_back(TagAttribute("url", testSharp(url)));
    }
};
...
{
  public:
    BindMaterialTag() : XMLTag("bind_material")
    {
    }
};
...
{
  public:
    InstanceMaterialTag(const QString& symbol, const QString& target) : XMLTag("instance_material")
    {
...
{
  public:
    ModifiedTag() : XMLLeafTag("modified")
    {
...
{
  public:
    InstanceVisualSceneTag(const QString& url) : XMLTag("instance_visual_scene")
    {
        _attributes.push_back(TagAttribute("url", testSharp(url)));
    }
};
...
class DocumentManager
{
  private:
    ...
    static void connectHierarchyNode(XMLInteriorNode* node0, XMLInteriorNode* node1, XMLInteriorNode* node2,
                                     XMLInteriorNode* node3, XMLNode* node4)
    {
  ...
  public:
    ...
    static XMLDocument* createColladaDocument(const MESHMODELTYPE& m, const int mask)
    {
        ...
        XLeaf* floatarr =
          new XLeaf(new Tags::FloatArrayTag(shape + "-lib-positions-array", m.vert.size() * return_component_number, m,
                                            Tags::FloatArrayTag::VERTPOSITION, return_component_number));
        XNode* techcommnode = new XNode(new Tags::TechniqueCommonTag());
        XNode* accessornode =
          new XNode(new Tags::AccessorTag(m.vert.size(), shape + "-lib-positions-array", return_component_number));
        ...
        bool normalmask =
          bool((mask & vcg::tri::io::Mask::IOM_FACENORMAL) || (mask & vcg::tri::io::Mask::IOM_WEDGNORMAL) ||
        ...
        if (normalmask)
        {
            ...
            XLeaf* floatnormarr =
              new XLeaf(new Tags::FloatArrayTag(shape + "-lib-normals-array", m.face.size() * return_component_number,
                                                m, Tags::FloatArrayTag::FACENORMAL, return_component_number));
            XNode* techcommnormnode = new XNode(new Tags::TechniqueCommonTag());
            XNode* accessornormnode =
              new XNode(new Tags::AccessorTag(m.face.size(), shape + "-lib-normals-array", return_component_number));
        ...
        if (texmask)
        {
            ...
            // we export only triangular face
            XLeaf* floatwedgearr = new XLeaf(
              new Tags::FloatArrayTag(shape + "-lib-map-array", m.face.size() * return_component_number * edgefacenum,
                                      m, Tags::FloatArrayTag::WEDGETEXCOORD, return_component_number));
            XNode* techcommwedgenode = new XNode(new Tags::TechniqueCommonTag());
            XNode* accessorwedgenode = new XNode(
              new Tags::AccessorTag(m.face.size() * edgefacenum, shape + "-lib-map-array", return_component_number));
        ...
        do
        {
            if ((m.textures.size() == 0) || (!texmask))
            {
                ...
                trianglesnode =
                  new XNode(new Tags::TrianglesTag(mytripatches[indmat].size(), "material" + QString::number(indmat)));
        ...
        for (unsigned int ii = 0; ii < m.textures.size(); ++ii)
        {
            XNode* instmatnode = new XNode(
              new Tags::InstanceMaterialTag("material" + QString::number(ii), "material" + QString::number(ii)));
