...
inline vcg::Trackball::Button QTKey2VCG(int key, Qt::KeyboardModifiers modifiers)
{
    ...
    switch (key)
    {
        case Qt::Key_W:
        case Qt::Key_Up:
            vcgbt = vcg::Trackball::KEY_UP;
            break;
        case Qt::Key_A:
        case Qt::Key_Left:
            vcgbt = vcg::Trackball::KEY_LEFT;
            break;
        case Qt::Key_S:
        case Qt::Key_Down:
            vcgbt = vcg::Trackball::KEY_DOWN;
            break;
        case Qt::Key_D:
        case Qt::Key_Right:
            vcgbt = vcg::Trackball::KEY_RIGHT;
            break;
        case Qt::Key_R:
        case Qt::Key_PageUp:
            vcgbt = vcg::Trackball::KEY_PGUP;
            break;
        case Qt::Key_F:
        case Qt::Key_PageDown:
            vcgbt = vcg::Trackball::KEY_PGDOWN;
            break;
        default:
            vcgbt = 0;
    }
