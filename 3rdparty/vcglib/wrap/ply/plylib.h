...
class PlyElement
{
  public:
    ...
    int AddToRead(const char *propname, int stotype1, int memtype1, size_t offset1, int islist, int alloclist,
...
class PlyFile
{
  ...
  public:
    ...
    int AddToRead(const char *elemname, const char *propname, int stotype1, int memtype1, size_t offset1, int islist,
                  int alloclist, int stotype2, int memtype2, size_t offset2);
    // Come sopra ma con descrittore
    inline int AddToRead(const PropDescriptor &p)
    {
        return AddToRead(p.elemname, p.propname, p.stotype1, p.memtype1, p.offset1, p.islist, p.alloclist, p.stotype2,
    ...
    inline const char *GetHeader() const
    {
        return header;
    }
