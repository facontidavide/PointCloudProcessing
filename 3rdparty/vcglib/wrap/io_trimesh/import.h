...
class Importer
{
  ...
  public:
    ...
    static bool ErrorCritical(int error)
    {
        switch (LastType())
        {
            ...
            case KT_OFF:
                ...
                break;
            case KT_OBJ:
                return ImporterOBJ<OpenMeshType>::ErrorCritical(error);
                break;
        }
    ...
    static const char *ErrorMsg(int error)
    {
        ...
        {
            case KT_PLY:
                return ImporterPLY<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_STL:
                return ImporterSTL<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_OFF:
                return ImporterOFF<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_OBJ:
                return ImporterOBJ<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_VMI:
                return ImporterVMI<OpenMeshType>::ErrorMsg(error);
                break;
        }
        return "Unknown type";
    }
