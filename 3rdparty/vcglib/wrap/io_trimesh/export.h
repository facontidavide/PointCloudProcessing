...
class Exporter
{
  ...
  public:
    ...
    static const char *ErrorMsg(int error)
    {
        ...
        {
            case KT_PLY:
                return ExporterPLY<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_STL:
                return ExporterSTL<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_OFF:
                return ExporterOFF<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_DXF:
                return ExporterDXF<OpenMeshType>::ErrorMsg(error);
                break;
            case KT_OBJ:
                return ExporterOBJ<OpenMeshType>::ErrorMsg(error);
                break;
        }
        return "Unknown type";
    }
